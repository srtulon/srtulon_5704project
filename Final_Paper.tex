...
\hline
 Kernel & Main Linux OS & Architecture & Status & Result \\ [0.5ex] 
\hline
 ...
 MirageOs & Ubuntu & x86 & Successfully compiled on machine but failed & Partial Success \\ 
 ...
 Unikraft & RaspbianOS & arm64 & Successfully compiled on machine but failed & Partial Success \\ 
  &  & & to boot anything other than helloworld &  \\
